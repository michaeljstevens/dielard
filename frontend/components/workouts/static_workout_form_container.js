...
import {createStaticWorkout, removeStaticWorkout} from '../../actions/static_workout_actions.js';
...
const mapDispatchToProps = (dispatch) => ({
  ...
  removeStaticWorkout: staticWorkout => dispatch(removeStaticWorkout(staticWorkout))
});
